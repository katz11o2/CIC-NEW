<script>
	...
	const logos = [
    { src: CIT, alt: 'CIT', class: 'h-11' },
	{ src: CIC, alt: 'CIC', class: 'h-12  ml-72' },
    { src: CHOSS, alt: 'CHOSS', class: 'h-12' },
     
];

const navLinks = [
    { href: '/about', text: 'About' },
    { href: '#	services', text: 'Initiatives' },
...
>
	<div class="container mx-auto px-6">
		...
		<nav>
			<a href="/">Home</a>
		   <a href="/login">Login</a>  <!-- This will now work -->
	   </nav>
		
		<!-- Mobile Header -->
		<div class="flex items-center justify-between md:hidden bg-gradient-to-br from-slate-800 via-blue-600/50 to-slate-800 w-full">
		...
		<div class="hidden md:block">
			...
			>
				...
				<div class="flex flex-col items-center relative">
					...
					/>
					{#if logo.alt === 'CIC'}
    <p class="absolute left-[325px] top-14 transform -translate-y-1/2 text-white text-[8px]">
